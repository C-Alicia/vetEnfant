 ...
 */
final class Version20250107152223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE is_role is_role TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE is_role is_role TINYINT(1) DEFAULT NULL COMMENT \'0 = Vendeur, 1 = Acheteur\'');
    }
}
