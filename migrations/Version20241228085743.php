 ...
 */
final class Version20241228085743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE claim (id INT AUTO_INCREMENT NOT NULL, order_ord_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, is_status TINYINT(1) NOT NULL, INDEX IDX_A769DE2725B9C320 (order_ord_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_ord (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, date_of_purchase DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_A847A45AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, order_ord_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, gender VARCHAR(255) DEFAULT NULL, size INT NOT NULL, state VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION NOT NULL, description LONGTEXT DEFAULT NULL, is_sold TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_D34A04AD25B9C320 (order_ord_id), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, order_ord_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, accepted_date DATETIME NOT NULL, shipping_date DATETIME NOT NULL, delivered_date DATETIME NOT NULL, discount DOUBLE PRECISION DEFAULT NULL, payment_date DATETIME NOT NULL, card_number VARCHAR(20) DEFAULT NULL, INDEX IDX_723705D125B9C320 (order_ord_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, last_name VARCHAR(180) DEFAULT NULL, first_name VARCHAR(180) DEFAULT NULL, date_of_birth DATETIME DEFAULT NULL, phone_number VARCHAR(20) DEFAULT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, profile_image VARCHAR(155) DEFAULT NULL, evaluation DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', is_active TINYINT(1) NOT NULL, is_role TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
